...
const RESUME_ITEMS = [
  {
    icon: ChartBarIcon,
    children: "Bachelor degree in Electronic Engineering",
  },
  {
    icon: PuzzlePieceIcon,
    children: "Certified Backend Developer",
  },
  {
    icon: CursorArrowRaysIcon,
    children: "Certified Oracle Frontend Developer",
  },
  {
    icon: CloudIcon,
    children: "AWS Essentials Badge",
  }
];
      ...
      <div className="container mx-auto grid w-full grid-cols-1 items-center gap-16 lg:grid-cols-2">
        <div className="col-span-1">
          ...
          <Typography className="mb-4 mt-3 w-9/12 font-normal !text-gray-500" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
            Highly skilled and creative Web Developer with 1+ years of
